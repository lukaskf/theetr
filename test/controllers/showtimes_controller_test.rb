...
class ShowtimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create showtime" do
    assert_difference('Showtime.count') do
      post showtimes_url, params: { showtime: { end_time: @showtime.end_time, seats_purchased: @showtime.seats_purchased, start_time: @showtime.start_time } }
    end
  ...
  test "should update showtime" do
    patch showtime_url(@showtime), params: { showtime: { end_time: @showtime.end_time, seats_purchased: @showtime.seats_purchased, start_time: @showtime.start_time } }
