...
class AuditoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auditorium" do
    assert_difference('Auditorium.count') do
      post auditoria_url, params: { auditorium: { seat_capacity: @auditorium.seat_capacity } }
    end
  ...
  test "should update auditorium" do
    patch auditorium_url(@auditorium), params: { auditorium: { seat_capacity: @auditorium.seat_capacity } }
